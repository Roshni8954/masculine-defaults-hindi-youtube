...
communities = {
    ...
    "self_help": [
        ...
        # ADD GaurGopalDas and BKShivani channel IDs here
    ],
    "gaming_esports": [
    ...
    "standup_comedy": [
        ...
        ("UCKnZHF24IV9PT0cdSdHoWug", "AnubhavSinghBassi"),
        ("UCkS7Vxu4PjM99w0Is6idjcg", "ZakirKhan"),
        ("UCAYum5hCyfkSH5T3vSD_kwQ", "AakashGupta"),
        ("UCAov2BBv1ZJav0c_yHEciAw", "SamayRaina"),
        ("UC4muYPMCSYigqIwRjVWkQ2Q", "Aupmanyu"),
        ("UCGmhWgV9bmslB0Levatl6qA", "HarshGujral"),
        ("UCHRaksEiMATBSF8OwnNe_zg", "ShreyaPriyam"),
        ("UCbjJZdJbaxGVW88CispTk8g", "UroojAshfaq"),
        ("UCVycT_OilwV-LfdqTtESCIA", "PannuGurleen"),
        ("UCbFGS5NZB0iI4eDIT_82t6Q", "SharonVerma"),
        ("UCllSh_d1Brc9PLypjhm1_YA", "SwatiSachdeva"),
        ("UCo10yRzepDzIt7B7w2wnM1Q", "PrashastiSingh"),
    ],
}
